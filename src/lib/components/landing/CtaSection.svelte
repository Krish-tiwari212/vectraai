<script lang="ts">
	import { BrainCircuit, ChevronRight, Lightbulb, MessageSquare, Mic, Sparkles, Workflow } from 'lucide-svelte';
	...
	<div class="flex w-full flex-col items-center justify-center">
		<div class="relative flex w-full flex-col items-center justify-center overflow-hidden">
			...
			<div class="absolute z-10">
				...
				>
					<BrainCircuit class="mx-auto size-16 text-black dark:text-white lg:size-24" />
				</div>
				<div class="z-10 mt-4 flex flex-col items-center text-center text-primary">
					<h1 class="text-2xl font-bold lg:text-4xl">Ready to transform your business with AI?</h1>
					<p class="mt-2">Schedule a free consultation with our AI experts today.</p>
					<Button size="lg" variant="outline" href="#contact" class="group mt-4 rounded-[2rem] px-6">
						Get in Touch
						<ChevronRight
